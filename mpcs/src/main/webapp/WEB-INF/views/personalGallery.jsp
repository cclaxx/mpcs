...
<body>
	...
	<header>
		<div id="main" class="container">
			...
			<p>Go to gallery!.</p>
			<a href="<spring:url value= "/user/gallery/map"/>"><button
					type="button" class="btn btn-primary">GO!</button></a>
		</div>
	</header>
	...
	<section>
		<div id="mapGallery" class="container-fluid gallery">
			...
			<div class="secondGallery">
				<a href="<spring:url value= "/user/gallery/classic"/>">Classic
					Gallery</a>
			</div>
		</div>
	...
	<section>
		...
		<div id="classicGallery" class="container-fluid gallery">
			...
			<div class="secondGallery">
				<a href="<spring:url value= "/user/gallery/map"/>">Map Gallery</a>
			</div>
		</div>
		<div id="fotoPreview">
			<div class="container">
